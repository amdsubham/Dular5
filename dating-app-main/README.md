# Welcome to the Dating App Template for `theappmarket.io` 👋

This is a template for a dating app that will be made for the `theappmarket.io` platform, created with Expo. It includes basic features for a dating app, such as user profiles, matching, and messaging.
