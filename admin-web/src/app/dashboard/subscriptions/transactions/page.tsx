    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Payment history and revenue analytics</p>
        </div>
        <button
      ...
      {revenueStats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-md p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-1">₹{revenueStats.totalRevenue.toLocaleString()}</div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-md p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-1">₹{revenueStats.monthRevenue.toLocaleString()}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {Object.entries(revenueStats.revenueByPlan).map(([planId, data]) => (
              <div key={planId} className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 mb-3 capitalize">{planId} Plan</h3>
                  ...
                  <td className="px-6 py-4">
                    {transaction.razorpayPaymentId ? (
                      <div className="text-sm font-mono text-gray-900">
                        {transaction.razorpayPaymentId.substring(0, 15)}...
                      </div>
                    ) : (
