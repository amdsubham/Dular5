      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Pricing & Limits */}
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Pricing & Limits</h2>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Plan is available for purchase</div>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Show "Popular" badge</div>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="border-2 border-primary-200 rounded-lg p-4 bg-primary-50/30">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">{formData.displayName}</h3>
                ...
                <div className="mb-3">
                  ...
                  <span className="text-sm text-gray-600 ml-1">/ {formData.duration} days</span>
                </div>
